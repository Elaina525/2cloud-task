export default function Awards() {
    return (
      <div className="bg-white px-6 sm:px-16 lg:px-20 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-left justify-center">
          
          {/* Member of Section */}
          <div className="mx-auto">
            <h3 className="text-gray-500 text-lg font-semibold uppercase mb-4">Member of</h3>
          ...
          <div className="mx-auto">
            <h3 className="text-gray-500 text-lg font-semibold uppercase mb-4">Proudly Climate Positive</h3>
            <div className="flex flex-wrap justify-start gap-4">
          ...
          {/* 2022 APPA Winner */}
          <div className="mx-auto">
            <h3 className="text-gray-500 text-lg font-semibold uppercase mb-4">2022 APPA Winner</h3>
