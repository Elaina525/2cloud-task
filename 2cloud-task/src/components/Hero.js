    ...
    <div className="container mx-auto px-6 lg:px-4 flex flex-col lg:flex-row items-center">
      <div className="text-white max-w-sm text-left">
        <h1 className="text-4xl lg:text-6xl font-bold">
          Punchy Promotional Products 🥊
        </h1>
        <p className="mt-4 text-lg">
          Trusted by Aussie and Global brands with their most valuable asset -
          their brand.
        </p>
    ...
    <div className="container mx-auto px-6 lg:px-60 flex flex-col lg:flex-row items-center">
      <div className="text-black max-w-sm text-left lg:ml-10">
        <h1 className="text-2xl lg:text-5xl font-bold">
          It&apos;s <span className="text-header-green">Good </span>
          <br />
          to be green
        </h1>
        <p className="mt-4 text-lg max-w-64">
          We&apos;re a member of{" "}
          <span className="underline">1% for the Planet</span> for our{" "}
          <span className="text-header-green">Good Range</span> of products,
          donating 1% of sales to environmental partners.
        </p>
