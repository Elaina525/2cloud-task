            ...
            <div className="flex items-center justify-between px-6 lg:px-20 py-4 bg-white relative">
                ...
                <nav className="hidden lg:flex items-center space-x-10 text-blue-600 font-semibold">
                    ...
                    >
                        ...
                        <div className={`fixed left-1/2 top-29 h-full transform -translate-x-1/2 bg-gray-100 shadow-lg w-[80vw] max-w-6xl flex justify-center z-50 transition-all duration-300 ease-in-out
                        ...
                        `}>
                            <div className="w-full max-w-6xl flex">
                                <div className="w-1/3 pl-6 bg-white">
                                    <h3 className="font-bold text-lg mb-3 text-gray-900">Product Categories</h3>
                                    {Object.keys(productCategories).map((category) => (
                                        <a
                                            key={category}
                                            href="#"
                                            className={`block py-2 px-3 rounded transition-colors ${
                                                activeCategory === category ? 'bg-gray-100 text-blue-600' : 'hover:bg-gray-50 text-gray-700'
                                            }`}
                                ...
                                <div className="w-1/3 px-6 bg-gray-100">
                                    {activeCategory && (
                                        <>
                                            <h4 className="font-semibold mb-3 text-gray-900">{activeCategory}</h4>
                                ...
                                <div className="w-1/3 pl-6 bg-gray-100 p-4 rounded-lg">
                                    <div className="bg-blue-400 text-black p-4 rounded-lg shadow-sm">
                                        <h3 className="font-bold text-lg mb-3">Made to order merch</h3>
                                        <p className="text-sm mb-4">
                                            Completely custom made to your exact size, colour and
                                            specifications. Choose Made to Order when volumes are higher
                                            and delivery date is &gt; 8 weeks for maximum impact.
                                        </p>
                                ...
                                <div className="mt-6 pt-4">
                                            <h4 className="text-sm font-semibold mb-3 text-gray-700">TRUSTED BY</h4>
                                            <div className="flex flex-col gap-3">
                                                <div className="flex items-center gap-3">
                                                    <img src="/netflix.png" className="h-6 w-auto opacity-90" alt="Netflix" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
