  ...
  const steps = [
    {
      ...
      description:
        "Browse our selection of off-the-shelf products or start from scratch",
  ...
  return (
    <div className="bg-white px-6 sm:px-16 lg:px-20 py-12">
      ...
      <p className="text-gray-600 text-lg mt-4 text-left">
        From concept to creation, we're here to make the act of ordering Good
        Things easier and more rewarding.
      </p>
